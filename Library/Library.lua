...
Description.FontFace = PoppinsFont
...
RunButton.ZIndex = 3
RunButton.FontFace = PoppinsFont
...
Universal.FontFace = PoppinsFont
...
TopbarTitle.FontFace = PoppinsFont
...
SearchBar.FontFace = PoppinsFont
...
Description_2.FontFace = PoppinsFont
...
Description_3.FontFace = PoppinsFont
...
RunButton_3.FontFace = PoppinsFont
...
SearchBar:GetPropertyChangedSignal("Text"):Connect(function()
	...
	for _, Card in pair(Commands_3:GetChildren()) do
		if (Card:IsA("Frame")) then
			if (string.find(string.lower(Card.Name), InputText)) then
				Card.Visible = true
			else
				Card.Visible = false
			end
